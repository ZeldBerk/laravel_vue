                        ...
                        <div class="col-md-12 col-lg-5">
                            <div class="row">
                                ...
                                <div class="col-12 d-flex align-items-center">
                                    <svg class="mr-1" width="20px" height="20px" viewBox="0 0 24 24"
                                        ...
                                        <g id="SVGRepo_iconCarrier">
                                            ...
                                            <g id="Complete">
                                                <g id="Clock">
                                                    <g>
                                                        <polyline fill="none"
                                                            points="11.9 5.9 11.9 11.9 12 12 14.1 14.1" stroke="#422329"
                                                            stroke-linecap="round" stroke-linejoin="round"
                                                            stroke-width="2"></polyline>
                                                        <circle cx="12" cy="12" data-name="Circle" fill="none"
                                                            id="Circle-2" r="10" stroke="#422329" stroke-linecap="round"
                                ...
                                <div class="col-12 d-flex align-items-center">
                                    <svg version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        viewBox="0 0 512 512" xml:space="preserve" fill="#000000" stroke="#000000"
                                        class="mr-1">
                                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round">
                                        </g>
                                        <g id="SVGRepo_iconCarrier">
                                            <g>
                                                ...
                                                <path style="fill:#422329;"
                                                    d="M385.228,34.75c-11.75,32.953-45.578,110.156-47.719,178.344c-3.313,105.844,61.547,90.188,62.703,159.531 v138.688h55.078l0.266,0.688c0,0,0-0.281,0-0.688c0-9.266,0-119.625,0-232.203c0-111.359,0-224.797,0-244.359 C455.556-5.438,403.524-16.531,385.228,34.75z">
                                                </path>
                                            </g>
                                        </g>
                                    </svg>
                                    ...
                                    <svg class="mr-1" width="20px" height="20px" viewBox="0 0 24 24" fill="none"
                                        ...
                                        <g id="SVGRepo_iconCarrier">
                                            <path
                                                ...
                                                stroke="#422329" stroke-width="1.5"></path>
                                            <path d="M7 4V2.5" stroke="#422329" stroke-width="1.5"
                                                stroke-linecap="round"></path>
                                            <path d="M17 4V2.5" stroke="#422329" stroke-width="1.5"
                                                stroke-linecap="round"></path>
                                            <path d="M2.5 9H21.5" stroke="#422329" stroke-width="1.5"
                                                stroke-linecap="round"></path>
                                            <path
