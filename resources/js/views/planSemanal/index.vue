  ...
  <div class="container card">
    ...
    <table>
      ...
      <tr v-for="dia in diasSemana" :key="dia">
        <th class="separador espacio">{{ dia }}</th>
        <td class="separador">
          <div class="contenedorRecetas">
            <template v-for="receta in filtrarRecetas(dia, 'Almuerzo')" :key="receta.id">
              <div>
                <a>{{ receta.nombre }}</a>
                <div @click.stop="detallesReceta(receta.receta_id)">
                  <svg width="35px" height="35px" viewBox="-2.4 -2.4 28.80 28.80" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M15.0007 12C15.0007 13.6569 13.6576 15 12.0007 15C10.3439 15 9.00073 13.6569 9.00073 12C9.00073 10.3431 10.3439 9 12.0007 9C13.6576 9 15.0007 10.3431 15.0007 12Z" stroke="#F59E0B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> <path d="M12.0012 5C7.52354 5 3.73326 7.94288 2.45898 12C3.73324 16.0571 7.52354 19 12.0012 19C16.4788 19 20.2691 16.0571 21.5434 12C20.2691 7.94291 16.4788 5 12.0012 5Z" stroke="#F59E0B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
                </div>
              </div>
            </template>
          </div>
...
export default {
  setup() {
    ...
    return { diasSemana, planSemanal, filtrarRecetas, detallesReceta }; 
  },
};
</script>
