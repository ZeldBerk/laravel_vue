    ...
    <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
        <div class="layout-topbar">
            <div class="contenedorHEADER">
                ...
                <div class="layout-topbar-menu collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li v-if="user?.name" class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle iconoNav" href="#" role="button"
                                ...
                                <svg class="iconoHover" fill="#000000" viewBox="-3.2 -3.2 22.40 22.40"
                                    ...
                                    <g id="SVGRepo_iconCarrier">
                                        <path
                                            ...
                                            fill="#030708"></path>
                                        <path d="M14 12C14 10.3431 12.6569 9 11 9H5C3.34315 9 2 10.3431 2 12V15H14V12Z"k
                                            fill="#030708"></path>
                                    </g>
                                </svg>
                            </a>
                            <ul class="dropdown-menu dropdown-menu-end">
                                ...
                                <li><a class="dropdown-item" href="javascript:void(0)" @click="logout">Cerrar
                                        Sessión</a>
                                </li>
                            </ul>
                        </li>
